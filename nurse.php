...
<div class="container-fluid text-center">
    <button class="btn" type="submit" name="login" style="border-radius:10px ;background-color: #053811;height: 191px;
    width: 436px;" data-toggle="modal" data-target="#myModal">ADD PATIENT</button>&nbsp&nbsp&nbsp&nbsp&nbsp
    <button class="btn" type="submit" name="login" style="border-radius:10px ;background-color: #053811;height: 191px;
    width: 436px;"><a href="viewp.php">VIEW PATIENT</a></button>&nbsp&nbsp&nbsp&nbsp&nbsp
...
">&times;</a>
    <img src="tempimgs/ki.jpg" class="cik">
     <ul class="u">
  <li class="active l">
 <span class="glyphicon glyphicon-home"></span><a href="nurse.php"><i class="fa fa-fw fa-dashboard"></i>Home</a>
 </li>
 <li class="active l">
