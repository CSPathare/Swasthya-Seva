...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">SWASTHYA-SEVA Center&nbsp:&nbsp<?php echo $cname1;?></a>
    </div>
...
<div class="container-fluid text-center" style="background-color: #fff;padding-top: 7%;padding-bottom: 7%;background-image: url(images/19.jpg);
  ...
  <h1 style="font-size: 55px;letter-spacing: 90px; font-family: -webkit-body; color: #fff">E-KRISHI</h1>
  <br>
...
$i=0;
  if($result = mysqli_query($dbconn,$query))
  {
      ...
      <p><b>Sowing Year:</b>&nbsp&nbsp'.$row[year].'</p>
      <p><b>Quantity:&nbsp&nbsp'.$row[info].'</b></p>
      </div>
      </div>
      </div>
    </div>';
...
//echo $contact;
    ...
    echo '<div class="col-md-4">
      ...
      <p><b>Quantity:&nbsp&nbsp</b>'.$row['info'].'</p>
      </span>
      </div>
      </div>
      </div>
...
">&times;</a>
    <img src="images/40.jpg" class="cik">
    <?php
